...
public class BannerView extends WebView {
	...
	private final String _TPL_URL = "%s/www/delivery/afr.php?refresh=%d&zoneid=%s&source=%s&target=%s&cb=%d&ct0=%s";
	...
	public BannerView loadAd(String source, String domain,String zoneId,int changeInterval) {
		...
		Log.v(LOGTAG, "BannerView.loadAd.zoneId:" + zoneId);
		Log.v(LOGTAG, "BannerView.loadAd.changeInterval:" + changeInterval);
